...
const features = [
  {
    name: 'Create your own profile for a better experience',
    description:
      'Get custom content and notifications according to your profile',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: 'Notifications on finished jobs',
    description: 'Get a push notification with the progress of the job.',
  ...
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        <AppScreen.Title>Create profile</AppScreen.Title>
        <AppScreen.Subtitle>
          Remember to activate{' '}
          <span className="text-white">push notifications</span> on your phone
        </AppScreen.Subtitle>
...
function StocksScreen({ custom, animated = false }) {
  return (
    <AppScreen className="w-full">
      <MotionAppScreenHeader {...(animated ? headerAnimation : {})}>
        <AppScreen.Title>Jobs: $8399</AppScreen.Title>
        <AppScreen.Subtitle> 1975 Porsche 911 Turbo</AppScreen.Subtitle>
      </MotionAppScreenHeader>
      <MotionAppScreenBody {...(animated ? { ...bodyAnimation, custom } : {})}>
        <div className="di vide-y divide-gray-100">
          {[
            {
              name: 'Paint fix',
              price: '$2,999',
